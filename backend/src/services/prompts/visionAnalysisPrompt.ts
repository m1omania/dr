...
- Топ-3 действия (пронумерованные, с пометкой "Быстрая победа")
...
ВСЕГДА отвечай на русском языке. Структурируй ответ кратко и ясно, как в примерах выше. Все заголовки разделов должны быть на русском: "ОБЩИЙ ОБЗОР", "СИЛЬНЫЕ СТОРОНЫ", "ПРОБЛЕМЫ", "РЕКОМЕНДАЦИИ", "ИТОГОВАЯ ОЦЕНКА". Не используй английские заголовки. Все пункты списков, все описания должны быть на русском языке. Используй "Быстрая победа" вместо "Quick win".  
